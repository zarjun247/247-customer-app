...
ALTER TABLE `store_skus`
  ...
  ADD INDEX `idx_store_skus_product_variant` (`productId`, `variantId`);
...
ALTER TABLE `batches`
  ...
  ADD INDEX `idx_batches_status_expiry` (`status`, `expiryDate`);
...
ALTER TABLE `orders`
  ...
  ADD INDEX `idx_orders_prescription` (`prescriptionId`);

ALTER TABLE `order_items`
  ADD INDEX `idx_order_items_order` (`orderId`),
  ADD INDEX `idx_order_items_product` (`productId`),
  ADD INDEX `idx_order_items_sku` (`storeSkuId`);
...
ALTER TABLE `audit_logs`
  ...
  ADD INDEX `idx_audit_logs_action_created` (`action`, `createdAt`);
...
ALTER TABLE `refunds`
  ...
  ADD INDEX `idx_refunds_status_created` (`status`, `createdAt`);

ALTER TABLE `suppliers`
  ADD INDEX `idx_suppliers_active_name` (`isActive`, `supplierName`),
  ADD INDEX `idx_suppliers_gstin` (`gstin`);
...
ALTER TABLE `stock_movements`
  ...
  ADD INDEX `idx_stock_movements_type_date` (`movementType`, `createdAt`);
...
ALTER TABLE `purchase_invoices`
  ...
  ADD INDEX `idx_purchase_invoices_invoice_no` (`invoiceNo`);
...
ALTER TABLE `supplier_payments`
  ...
  ADD INDEX `idx_supplier_payments_voucher_no` (`voucherNo`);

ALTER TABLE `supplier_payment_allocations`
  ADD INDEX `idx_supplier_alloc_purchase_invoice` (`purchaseInvoiceId`),
  ADD INDEX `idx_supplier_alloc_payment` (`supplierPaymentId`);
...
ALTER TABLE `h1_register`
  ...
  ADD INDEX `idx_h1_register_patient_phone` (`patientPhone`);

ALTER TABLE `product_barcodes`
  ADD INDEX `idx_product_barcodes_barcode` (`barcode`),
  ADD INDEX `idx_product_barcodes_product` (`productId`);

ALTER TABLE `barcode_aliases`
  ADD INDEX `idx_barcode_aliases_product_batch` (`productId`, `batchId`),
  ADD INDEX `idx_barcode_aliases_store_active` (`storeId`, `isActive`);
...
ALTER TABLE `batch_ledger`
  ...
  ADD INDEX `idx_batch_ledger_supplier_invoice` (`supplierId`, `purchaseInvoiceId`);
...
ALTER TABLE `stock_reservations`
  ...
  ADD INDEX `idx_stock_reservations_cart_status` (`cartId`, `status`);
