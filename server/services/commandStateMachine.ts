...
export type CommandTransitionTrigger = "handler_success" | "handler_failure" | "compensation_run";
...
export const LEGAL_COMMAND_STATES: ReadonlySet<CommandState> = new Set<CommandState>([
  "in_flight",
  "completed",
  "failed",
  "compensated",
