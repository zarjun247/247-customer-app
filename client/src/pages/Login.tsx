    ...
    >
      ...
      {step !== "entry" && (
        <div className="px-5 pt-5">
          <button
            onClick={() =>
              step === "otp" ? setStep("phone") : setStep("entry")
            }
        ...
        {step === "entry" && (
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={!isManusSSOConfigured()}
              className="w-full h-12 flex items-center justify-between px-4 rounded-xl border transition-all disabled:opacity-40 disabled:cursor-not-allowed"
              style={{
                background: "#141416",
                borderColor: "#2A2A2E",
                color: "#F0F0F2",
