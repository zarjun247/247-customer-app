# OPEN PR CLOSURE COMMENTS

Use these exact templates when authenticated GitHub access is available and the PR has been verified as safe to close or unsafe to merge raw.
