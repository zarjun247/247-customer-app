...
- Stale PR cleanup completion/tracking is recorded in `STALE_PR_STATUS.md`.
- Current production truth after Prompt 12 is recorded in `CURRENT_MAIN_TRUTH_AFTER_PROMPT_12.md`.
