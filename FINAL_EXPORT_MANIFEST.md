...
- Stale PR cleanup status is tracked in `STALE_PR_STATUS.md`.
- Current production truth after Prompt 12 is in `CURRENT_MAIN_TRUTH_AFTER_PROMPT_12.md`.
- Next implementation branch: `feat/barcode-production-ux`.
