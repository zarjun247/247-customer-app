...
- Current open-PR truth is tracked in `OPEN_PR_CONTROL_ROOM.md`.
- Next safe rebuild order is tracked in `NEXT_REBUILD_QUEUE.md`.
- PR closure language is tracked in `OPEN_PR_CLOSURE_COMMENTS.md`.
